...
- component/assets/buttons.scss: 투명버튼 추가(검색용)
- component/assets/forms.scss: form 스타일링
- component/assets/inputs.scss: input 컴포넌트 리팩토링 및 변수명 수정, 클래스명 수정
- component/assets/layout.scss: 클래스명 수정
- component/assets/mixins.scss: 변수명 수정
- component/assets/variables.scss: 변수명 수정
- component/assets/header.scss: 변수명 수정
- signup/index.html: 스타일링 및 스크립트 연결
- signup/signup.js: 회원가입 유효성 검사 추가
- styles/style.scss: 버튼 컴포넌트 import
