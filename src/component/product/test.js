...
(async function () {
  ...
  function CustomSwiper(className, collectionName) {
    const swiper = new Swiper(`${className} .swiper-container`, {
      ...
      on: {
        init: function () {
          renderProductItem(className, this, collectionName);
  ...
  const swiper1 = new CustomSwiper(".product-slide1", productsData);
  const swiper2 = new CustomSwiper(".product-slide2", specialProductsData);
