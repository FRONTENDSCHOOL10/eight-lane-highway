...
<nav>
  <div class="header__container">
    ...
    <ul class="header__user-auth">
      <li class="user-auth__singup"><a href="">회원가입</a></li>
    ...
    <div class="header__search">
      <label for="headerSearch" class="sr-only search__label "></label>
      <input
        type="text"
        id="headerSearch"
        class="search__input"
        placeholder="검색어를 입력해주세요" />
      <button type="button" class="search__button"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
      <path d="M18.0811 18.081L13.9611 13.961M8.4671 15.334C9.36888 15.334 10.2618 15.1564 11.095 14.8113C11.9281 14.4662 12.6851 13.9604 13.3228 13.3227C13.9605 12.685 14.4663 11.928 14.8114 11.0949C15.1565 10.2617 15.3341 9.36879 15.3341 8.467C15.3341 7.56522 15.1565 6.67226 14.8114 5.83912C14.4663 5.00598 13.9605 4.24896 13.3228 3.6113C12.6851 2.97364 11.9281 2.46782 11.095 2.12272C10.2618 1.77763 9.36888 1.60001 8.4671 1.60001C6.64585 1.60001 4.89921 2.32349 3.61139 3.6113C2.32358 4.89912 1.6001 6.64576 1.6001 8.467C1.6001 10.2882 2.32358 12.0349 3.61139 13.3227C4.89921 14.6105 6.64585 15.334 8.4671 15.334V15.334Z" stroke="#5F0080" stroke-width="1.7" stroke-linecap="round"/>
      </svg></button>
    </div>
    <ul class="header__user-service">
      <li class="user-service__address-box" tabindex="0">
      <svg xmlns="http://www.w3.org/2000/svg"class="user-service__address" width="36" height="36" viewBox="0 0 36 36" fill="none">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M18.0062 30C18.0062 30 8.7002 22.544 8.7002 15.306C8.7002 12.8379 9.68065 10.4709 11.4259 8.72566C13.1711 6.98045 15.5381 6 18.0062 6C20.4743 6 22.8413 6.98045 24.5865 8.72566C26.3317 10.4709 27.3122 12.8379 27.3122 15.306C27.3122 22.544 18.0062 30 18.0062 30Z" stroke="#333333" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M17.9124 17.907C19.45 17.907 20.6964 16.6606 20.6964 15.123C20.6964 13.5854 19.45 12.339 17.9124 12.339C16.3749 12.339 15.1284 13.5854 15.1284 15.123C15.1284 16.6606 16.3749 17.907 17.9124 17.907Z" stroke="#333333" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="round"/>
    </svg>
        <div class="user-service__address-modal">
          ...
          <button
            type="button"
            class="user-service__address-modal__address">
            주소 검색
          </button>
        </div>
      </li>
      <li class="user-service__heart"><a href=""><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M28.9269 8.89299C28.3269 8.29265 27.6146 7.81641 26.8305 7.49148C26.0465 7.16656 25.2061 6.99931 24.3574 6.99931C23.5086 6.99931 22.6682 7.16656 21.8842 7.49148C21.1001 7.81641 20.3878 8.29265 19.7879 8.89299L17.9589 10.721L16.1319 8.89299C14.9201 7.68095 13.2765 6.99993 11.5626 6.99975C9.84867 6.99956 8.2049 7.68022 6.99286 8.89199C5.78082 10.1038 5.0998 11.7474 5.09961 13.4613C5.09942 15.1752 5.78008 16.819 6.99186 18.031L8.81986 19.86L17.2519 28.294C17.4394 28.4815 17.6937 28.5868 17.9589 28.5868C18.224 28.5868 18.4783 28.4815 18.6659 28.294L27.0989 19.86L28.9269 18.032C29.5271 17.4321 30.0032 16.7198 30.328 15.9358C30.6528 15.1519 30.82 14.3116 30.82 13.463C30.82 12.6144 30.6528 11.7741 30.328 10.9901C30.0032 10.2062 29.5271 9.4939 28.9269 8.89399V8.89299Z" stroke="#333333" stroke-width="1.7" stroke-linecap="round"/>
    </svg></a></li>
      <li class="user-service__cart"><a href=""><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M30.8442 10.207L28.1242 21.777H12.5342L9.82422 10.207H30.8442Z" stroke="#333333" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="round"/>
      <path d="M25.6839 29.467C26.8658 29.467 27.8239 28.5089 27.8239 27.327C27.8239 26.1451 26.8658 25.187 25.6839 25.187C24.5021 25.187 23.5439 26.1451 23.5439 27.327C23.5439 28.5089 24.5021 29.467 25.6839 29.467Z" stroke="#333333" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="round"/>
      <path d="M14.974 29.467C16.1559 29.467 17.114 28.5089 17.114 27.327C17.114 26.1451 16.1559 25.187 14.974 25.187C13.7921 25.187 12.834 26.1451 12.834 27.327C12.834 28.5089 13.7921 29.467 14.974 29.467Z" stroke="#333333" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="round"/>
      <path d="M5.16406 6.547H8.96406L10.7241 14.047" stroke="#333333" stroke-width="1.7" stroke-linecap="square" stroke-linejoin="round"/>
    </svg></a></li>
    </ul>
  </div>
  <div class="header__container">
...
export class Header extends HTMLElement {
  constructor() {
    ...
    this.userAuth = this.headerContainer.querySelector(".header__user-auth");
    this.customerService = this.userAuth.querySelector(
      ".user-auth__customer-service"
    );
    this.noticeBox = this.userAuth.querySelector(".user-auth__notice-box");
  ...
  connectedCallback() {
    ...
    this.customerService.addEventListener("mouseover", () => {
      this.noticeBox.classList.add("show");
    });
    this.customerService.addEventListener("mouseleave", () => {
      this.noticeBox.classList.remove("show");
    });
  }
}
