...
`;class l extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(e.content.cloneNode(!0))}connectedCallback(){}}customElements.define("c-footer",l);const o=document.createElement("c-footer");a.append(o);
